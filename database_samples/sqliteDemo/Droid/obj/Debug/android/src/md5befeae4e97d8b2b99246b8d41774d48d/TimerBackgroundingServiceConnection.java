...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Forms.CommonCore.TimerBackgroundingServiceConnection, sqliteDemo.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", TimerBackgroundingServiceConnection.class, __md_methods);
	}


	public TimerBackgroundingServiceConnection ()
	{
		super ();
		if (getClass () == TimerBackgroundingServiceConnection.class)
			mono.android.TypeManager.Activate ("Xamarin.Forms.CommonCore.TimerBackgroundingServiceConnection, sqliteDemo.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
