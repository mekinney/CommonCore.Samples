...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Forms.CommonCore.CoreStackLayoutRenderer, tabbedReference.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", CoreStackLayoutRenderer.class, __md_methods);
	}
	...
	public CoreStackLayoutRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == CoreStackLayoutRenderer.class)
			mono.android.TypeManager.Activate ("Xamarin.Forms.CommonCore.CoreStackLayoutRenderer, tabbedReference.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
